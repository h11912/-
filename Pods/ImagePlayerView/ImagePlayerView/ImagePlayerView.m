...
- (void)_init
{
    ...
    UIColor *color = [UIColor colorWithRed:((float)((0xFD560D & 0xFF0000) >> 16))/255.0
                                     green:((float)((0xFD560D & 0xFF00) >> 8))/255.0
                                      blue:((float)(0xFD560D & 0xFF))/255.0 alpha:1.0];
    
    UIColor *colorr = [UIColor colorWithRed:((float)((0xFFFFFF & 0xFF0000) >> 16))/255.0
                                     green:((float)((0xFFFFFF & 0xFF00) >> 8))/255.0
                                      blue:((float)(0xFFFFFF & 0xFF))/255.0 alpha:0.5];
    self.pageControl.currentPageIndicatorTintColor =color;
    self.pageControl.pageIndicatorTintColor = colorr;
